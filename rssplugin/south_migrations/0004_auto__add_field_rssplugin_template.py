...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RSSPlugin.template'
        db.add_column(u'rssplugin_rssplugin', 'template',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RSSPlugin.template'
        db.delete_column(u'rssplugin_rssplugin', 'template')
    ...
    models = {
        ...
        u'rssplugin.rssplugin': {
            ...
            'template': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
